...
/**
 * The {@link PubSubToBigQueryFhir} pipeline is a streaming pipeline which ingests data in JSON format
 ...
 * -Dexec.mainClass=com.google.cloud.teleport.templates.PubSubToBigQueryFhir \
 ...
 * </pre>
 */
public class PubSubToBigQueryFhir {

  /** The log to output status messages to. */
  private static final Logger LOG = LoggerFactory.getLogger(PubSubToBigQueryFhir.class);
   ...
   * PubSubToBigQueryFhir#run(Options)} method to start the pipeline and invoke {@code
   ...
   *
   * <ul>
   *   <li>{@link PubSubToBigQueryFhir#UDF_OUT} - Contains all {@link FailsafeElement} records
   *       successfully processed by the optional UDF.
   *   <li>{@link PubSubToBigQueryFhir#UDF_DEADLETTER_OUT} - Contains all {@link FailsafeElement}
   *       records which failed processing during the UDF execution.
   *   <li>{@link PubSubToBigQueryFhir#TRANSFORM_OUT} - Contains all records successfully converted from
   *       JSON to {@link TableRow} objects.
   *   <li>{@link PubSubToBigQueryFhir#TRANSFORM_DEADLETTER_OUT} - Contains all {@link FailsafeElement}
